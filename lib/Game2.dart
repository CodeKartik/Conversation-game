...
class Game2 extends StatefulWidget {
  const Game2({Key? key, required this.convType}) : super(key: key);
  final convType;
...
class _Game2State extends State<Game2> {
  ...
  List<UserCommands> rinasCommands = [
    UserCommands('I am outside', 'मैं बाहर हूँ |'),
    UserCommands('I will come back', 'मैं वापस आऊँगा |'),
    UserCommands('In 5 minutes', '5 मिनट में |'),
  ];

  List<UserCommands> ravisCommands = [
    UserCommands('I was wating', 'मैं इंतजार कर रहा था |'),
    UserCommands('when', 'कब ?'),
    UserCommands('ok', 'ठीक है |'),
  ];
